...
export function diffIDL(
  clientIDL: Record<string, any>,
  serverIDL: Record<string, any>
): ContractDelta[] {
...
function extractInterfaces(idl: Record<string, any>): Record<string, any> {
...
function extractStructs(idl: Record<string, any>): Record<string, any> {
  const result: Record<string, any> = {};
...
function extractEnums(idl: Record<string, any>): Record<string, any> {
  const result: Record<string, any> = {};
...
function extractErrors(idl: Record<string, any>): Record<string, any> {
  const result: Record<string, any> = {};
...
function extractEnumValues(enumData: any): Record<string, boolean> {

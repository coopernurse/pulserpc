...
func writeInterfaceClientCs(sb *strings.Builder, iface *parser.Interface, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum) {
	...
	sb.WriteString("        else\n")
	sb.WriteString("        {\n")
	sb.WriteString("            clientIDL = JsonSerializer.Deserialize<object>(IDL_JSON);\n")
	sb.WriteString("        }\n\n")
	sb.WriteString("        object? serverIDL = null;\n")
	sb.WriteString("        var idlObj = JsonSerializer.Deserialize<object>(IDL_JSON);\n")
	...
	sb.WriteString("            ServerChecksum = serverIDL != null ? DiffEngine.ComputeChecksum(serverIDL) : string.Empty,\n")
	sb.WriteString("            ClientChecksum = clientIDL != null ? DiffEngine.ComputeChecksum(clientIDL) : string.Empty,\n")

...
func (p *CSharpClientServer) Generate(idl *parser.IDL, fs *flag.FlagSet) error {
	...
	for _, namespace := range namespaces {
		...
		typesCode := generateTypesCs(namespace, types, structMap, enumMap)
		...
		serverNsCode := generateNamespaceServerCs(namespace, types, structMap, enumMap)
		...
		clientNsCode := generateNamespaceClientCs(namespace, types, structMap, enumMap)
...
func generateTypesCs(namespace string, types *NamespaceTypes, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum) string {
	var sb strings.Builder
...
func generateNamespaceServerCs(namespace string, _ *NamespaceTypes, _ map[string]*parser.Struct, _ map[string]*parser.Enum) string {
	var sb strings.Builder
...
func generateNamespaceClientCs(namespace string, _ *NamespaceTypes, _ map[string]*parser.Struct, _ map[string]*parser.Enum) string {
	var sb strings.Builder

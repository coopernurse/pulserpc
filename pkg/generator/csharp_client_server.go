...
func (p *CSharpClientServer) Generate(idl *parser.IDL, fs *flag.FlagSet) error {
	...
	// Generate Client.cs
	clientCode := generateClientCs(idl, structMap, enumMap, namespaceMap, paths)
...
func generateClientCs(idl *parser.IDL, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum, namespaceMap map[string]*NamespaceTypes, paths CSharpNamespacePaths) string {
	var sb strings.Builder

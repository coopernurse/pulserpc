...
func (p *CSharpClientServer) Generate(idl *parser.IDL, fs *flag.FlagSet) error {
	...
	for _, namespace := range namespaces {
		...
		namespaceCode := generateNamespaceCs(namespace, namespaces, types, structMap, enumMap, paths)
		...
		typesCode := generateTypesCs(namespace, types, structMap, enumMap, paths)
		...
		serverNsCode := generateNamespaceServerCs(namespace, types, structMap, enumMap, paths)
		...
		clientNsCode := generateNamespaceClientCs(namespace, types, structMap, enumMap, paths)
...
func generateNamespaceCs(namespace string, allNamespaces []string, types *NamespaceTypes, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum, paths CSharpNamespacePaths) string {
...
func generateTypesCs(namespace string, types *NamespaceTypes, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum, paths CSharpNamespacePaths) string {
	var sb strings.Builder
...
func generateNamespaceServerCs(namespace string, _ *NamespaceTypes, _ map[string]*parser.Struct, _ map[string]*parser.Enum, paths CSharpNamespacePaths) string {
	var sb strings.Builder
...
func generateNamespaceClientCs(namespace string, _ *NamespaceTypes, _ map[string]*parser.Struct, _ map[string]*parser.Enum, paths CSharpNamespacePaths) string {
	var sb strings.Builder

...
func generateServerPy(idl *parser.IDL, _ map[string]*parser.Struct, _ map[string]*parser.Enum, _ map[string]*parser.Interface, namespaceMap map[string]*NamespaceTypes, _outputDir string, idlJson string) string {
	var sb strings.Builder

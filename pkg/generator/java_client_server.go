...
func (p *JavaClientServer) Generate(idl *parser.IDL, fs *flag.FlagSet) error {
	...
	clientCodePkg := generateClientJava(idl, namespaceMap, basePackage, basePackage, string(idlJSON))
...
func generateClientJava(_ *parser.IDL, namespaceMap map[string]*NamespaceTypes, basePackage string, packageDecl string, idlJson string) string {
	var sb strings.Builder
	...
	sb.WriteString(escapeJavaString(idlJson))
	sb.WriteString(";\n\n")
	sb.WriteString("    private static String extractChecksum(Object idl) {\n")
	sb.WriteString("        if (idl instanceof Map) {\n")
	sb.WriteString("            Object checksum = ((Map<?, ?>) idl).get(\"checksum\");\n")
	sb.WriteString("            if (checksum != null) {\n")
	sb.WriteString("                return checksum.toString();\n")
	sb.WriteString("            }\n")
	sb.WriteString("        }\n")
	sb.WriteString("        return \"\";\n")
	sb.WriteString("    }\n\n")
	...
	sb.WriteString("    private ContractAuditor auditor;\n")
	sb.WriteString("    private boolean verifyOnBootstrap;\n\n")
	...
	sb.WriteString("    public Client withAuditor(ContractAuditor auditor) {\n")
	sb.WriteString("        this.auditor = auditor;\n")
	sb.WriteString("        return this;\n")
	sb.WriteString("    }\n\n")

	sb.WriteString("    public Client verifyOnBootstrap() {\n")
	sb.WriteString("        this.verifyOnBootstrap = true;\n")
	sb.WriteString("        return this;\n")
	sb.WriteString("    }\n\n")

	sb.WriteString("    public VerificationResult verifyCompatibility() {\n")
	sb.WriteString("        Object clientIDL = jsonParser.fromJson(IDL_JSON, Object.class);\n")
	sb.WriteString("        Object serverIDL = jsonParser.fromJson(IDL_JSON, Object.class);\n\n")
	sb.WriteString("        List<ContractDelta> deltas = DiffEngine.diffIDL(clientIDL, serverIDL);\n\n")
	sb.WriteString("        boolean compatible = true;\n")
	sb.WriteString("        for (ContractDelta delta : deltas) {\n")
	sb.WriteString("            if (delta.getSeverity() == ContractDelta.Severity.Error) {\n")
	sb.WriteString("                compatible = false;\n")
	sb.WriteString("                break;\n")
	sb.WriteString("            }\n")
	sb.WriteString("        }\n\n")
	sb.WriteString("        VerificationResult result = new VerificationResult(\n")
	sb.WriteString("            compatible,\n")
	sb.WriteString("            extractChecksum(serverIDL),\n")
	sb.WriteString("            extractChecksum(clientIDL),\n")
	sb.WriteString("            deltas,\n")
	sb.WriteString("            System.currentTimeMillis()\n")
	sb.WriteString("        );\n\n")
	sb.WriteString("        if (auditor != null) {\n")
	sb.WriteString("            auditor.audit(result);\n")
	sb.WriteString("        }\n\n")
